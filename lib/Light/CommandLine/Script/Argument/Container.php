...
class Light_CommandLine_Script_Argument_Container {
    ...
    */
   public function &addStringArgument( $name, $description ) {
    ...
    * @return Light_CommandLine_Script_Argument
    */
   public function &addBooleanArgument( $name, $description ) {
      $arg = new Light_CommandLine_Script_Argument( $name, $description );
   ...
   public function &addIntegerArgument( $name, $description ) {
      $arg = new Light_CommandLine_Script_Argument( $name, $description );
      $arg->setPattern('/^\d+$/');
